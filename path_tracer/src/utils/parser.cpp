...
std::vector<std::tuple<std::string, material_data>> parse_materials(std::string const& config_path)
{
    ...
    for (auto& material : config["materials"])
    {
        ...
        data.subsurface_radius = { material["subsurface_radius"][0], material["subsurface_radius"][1], material["subsurface_radius"][2] };
        data.subsurface_color = { material["subsurface_color"][0], material["subsurface_color"][1], material["subsurface_color"][2] };
